...
@section('content')
    ...
    <div class="admin-stats-grid">
        ...
        <a href="{{ route('admin.messages.index') }}" class="admin-stat-card">
            <i class="bi bi-envelope"></i>
            <div>
                <span class="admin-stat-value">{{ $stats['messages_count'] }}</span>
                <span class="admin-stat-label">Messages ({{ $stats['unread_messages_count'] }} non lus)</span>
            </div>
        </a>
    </div>
